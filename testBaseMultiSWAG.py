...
for base_model in args.models:
    print("Using model %s" % base_model)
    model_cfg = getattr(models, base_model)
    ...
    base_model_file = base_model+"models/swag-200.pt" 
    print("Loading model %s" % base_model_file)
